...
var match_1 = require("../build/match");
var class_defs_1 = require("../build/class_defs");
describe('Matching', function () {
    ...
    describe('#timeChecks()', function () {
        ...
        it('should produce no results. dates dont overlap', function (done) {
            var rider1 = new class_defs_1.Rider(1, 10, new Date("2011-13-01 00:00:00"), new class_defs_1.Time(14, 34), new class_defs_1.Time(15, 21), [sj], cp);
