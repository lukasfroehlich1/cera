...
app.post("/drivers", function (req, res) {
    ...
    async.waterfall([
        function addDriver(driverCallback) {
            api.addDriver(req.session.userId, packet.departure_date, packet.leave_earliest, packet.leave_latest, "", packet.end_point, parseInt(packet.startId), packet.threshold, packet.price_seat, packet.seats, driverCallback);
        },
