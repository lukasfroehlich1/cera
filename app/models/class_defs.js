...
export class Driver {
  constructor(id, user_id, leave_date, leave_earliest, leave_latest, waypoints,
              end_point, start_point, threshold, price_seat, seats) {
    this.id = id;
...
export class Match {
  constructor(rider_id, driver_id, rider_end_point, new_trip_time,
              leave_date, leave_earliest, leave_latest) {
